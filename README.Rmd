...
For examples of reports that can be generated using the `linkrep` package, download and view the sample [Final Report](https://github.com/CHIMB/linkrep/raw/main/inst/docs/Sample Final Report.pdf) and [Sensitivity Analysis Report](https://github.com/CHIMB/linkrep/raw/main/inst/docs/Sample Sensitivity Analysis Report.pdf) which uses fake/synthetic data to better help showcase the elements that make up each report.
