...
abbreviations_function <- read_data(params$abbreviations_generator_function_path, "abbreviations_generator_function_path")
...
`r if(!is.null(abbreviations_data) & !is.null(abbreviations_function)) "::: {.content-visible}" else "::: {.content-hidden}"`
...
if (!is.null(abbreviations_data) & !is.null(abbreviations_function) & params$output_format == "pdf"){
  abbreviations_function(
...
if (!is.null(abbreviations_data) & !is.null(abbreviations_function) & params$output_format == "docx"){
  abbreviations_function(
    data = abbreviations_data, 
    output_format = params$output_format)
}
...
`r if (is.null(algorithm_summary_table) & is.null(performance_measures_table) &!is.null(missingness_table)) "::: {.content-visible}" else "::: {.content-hidden}"` {{< pagebreak >}} :::
